...
<header>
    ...
    <nav>
        <ul class="desktop-menu">
            <li><a id="1" onclick="toggle(1)" class="link" href="zbirna-tabela">Zbirna tabela</a></li>
            <li><a id="2" onclick="toggle(2)" class="link" href="pojedinacne-tabele">Pojedinačne tabele</a></li>
